...
class ChatCompletionGenerator:
    ...
    def generate_completion(self, messages: List[dict], model: Optional[str]=MODEL, temperature: Optional[float]="0.33") -> str:
        ...
        """
        print(colored("Generating completion...", 'magenta'))
        print(colored(f"Current context length: {sum_content_length(messages)}", 'red'))
        ...
        print(colored("Completion generated.", 'magenta'))
